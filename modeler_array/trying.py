...
# TRYTHING TO SEE IF I CAN DO RANGE IN HERE 
    ...
    for obj in DICT.values():
        if obj['render']:
            ...
            for face in obj_class.faces:
                ...
                if RENDER_DISTANCE_LEFT < (all_vertices[adjusted_indices[0]][0] - cam_pos[0]) < RENDER_DISTANCE_RIGHT:
                    if RENDER_DISTANCE_BEHIND < all_vertices[adjusted_indices[0]][2] - cam_pos[2] < RENDER_DISTANCE_FAR:
